...
|-------------------|---------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|
| communicationType | Название типа коммуникации. <br/>Пример: корпоративный мессенджер,<br/>виджет на сайте для ответов клиенту,<br/>интеграция с telegram | TELEGRAM_BOT, CORPORATE_MSNGR            |
...
| sentDate    | Дата отправки сообщения. Устанавливается внешней системой     | 2025-04-05T14:29:59                      |
...
#### 3. Бизнес-правила
**Chat**
1. **Типы чатов и коммуникаций**:
   - Для каждого типа чата (`chatType`) и способа коммуникации (`communicationType`) могут быть свои правила видимости и доступа устанавливаемые внешней системой
...
1. **Время отправки и создания**:
   - `sentDate` может быть установлено внешней системой, но не может быть позже текущего времени
